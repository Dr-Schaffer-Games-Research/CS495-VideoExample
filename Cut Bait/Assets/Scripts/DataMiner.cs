...
public class DataMiner : MonoBehaviour
{
    ...
    public void LogData()
    {
        ...
        logString += ID + ", " + version + ", " + playTime.ToString() + ", " + day1CorrectDecisions.ToString() + ", " + day2CorrectDecisions.ToString() + ", " + day3CorrectDecisions.ToString() + ", " + day4CorrectDecisions.ToString() + ", " +
